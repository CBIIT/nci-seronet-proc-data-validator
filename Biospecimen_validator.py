...
################################################################################################################################################
            ...
            for i in enumerate(test_value):
                Biospecimen_object.in_list(header_name,i[1],["Positive Sample"],error_msg,test_value.index[i[0]],'Error')
            ...
            for i in enumerate(test_value):
                Biospecimen_object.in_list(header_name,i[1],["Negative Sample"],error_msg,test_value.index[i[0]],'Error')
...
#################################################################################################################################################
            ...
            for i in enumerate(has_data_column):
                Biospecimen_object.in_list(header_name,i[1],test_string,error_msg,has_data_column.index[i[0]],'Error')
            for i in enumerate(missing_data_column):
                Biospecimen_object.is_required(header_name,i[1],"All",missing_data_column.index[i[0]],'Error')
#################################################################################################################################################        
            ...
            for i in enumerate(has_data_column):
                Biospecimen_object.is_date_time(header_name,i[1],False,error_msg,has_data_column.index[i[0]],'Error')
            for i in enumerate(missing_data_column):
                Biospecimen_object.is_required(header_name,i[1],"All",missing_data_column.index[i[0]],'Error')
#################################################################################################################################################
...
#################################################################################################################################################
            ...
            for i in enumerate(test_value):
                Biospecimen_object.is_numeric(header_name,False,i[1],0,error_msg,test_value.index[i[0]],'Error')
...
#################################################################################################################################################
            ...
            for i in enumerate(has_data_column):
                Biospecimen_object.is_numeric(header_name,True,i[1],0,error_msg,has_data_column.index[i[0]],'Error')
            for i in enumerate(missing_data_column):
                Biospecimen_object.is_required(header_name,i[1],"All",missing_data_column.index[i[0]],'Error')       
#################################################################################################################################################
...
#################################################################################################################################################
            ...
            for i in enumerate(has_data_column):
                Biospecimen_object.is_string(header_name,i[1],False,error_msg,has_data_column.index[i[0]],'Error')
            for i in enumerate(missing_data_column):
                Biospecimen_object.is_required(header_name,i[1],"All",missing_data_column.index[i[0]],'Error')
#################################################################################################################################################                      
            ...
            for i in enumerate(test_value):
                Biospecimen_object.is_numeric(header_name,True,i[1],0,error_msg,test_value.index[i[0]],'Error')
...
#################################################################################################################################################
            ...
            test_value = Biospecimen_object.Data_Table[Biospecimen_object.Data_Table['Biospecimen_Type'] == "Serum"][header_name]
            for i in enumerate(test_value):
                Biospecimen_object.is_date_time(header_name,i[1],False,error_msg,test_value.index[i[0]],'Error')
...
#################################################################################################################################################
            ...
            for i in enumerate(has_data_column):
                Biospecimen_object.is_numeric(header_name,False,i[1],0,error_msg,has_data_column.index[i[0]],'Error')
            for i in enumerate(missing_data_column):
                Biospecimen_object.is_required(header_name,i[1],"All",missing_data_column.index[i[0]],'Error')
#################################################################################################################################################
