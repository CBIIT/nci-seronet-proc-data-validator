...
#################################################################################################################################################
        elif ('Date_of' in header_name) or ('Expiration_Date' in header_name) or ('Time_of' in header_name):
            if 'Time_of' in header_name:
...
#################################################################################################################################################
        current_object.biospecimen_count_check('Hemocytometer_Count')
        current_object.biospecimen_count_check('Automated_Count')
###############################################################################################################################
