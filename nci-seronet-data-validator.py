...
#            submitting_center,part_count,bio_count = get_submission_metadata(s3_client,temp_file_loc,files_to_check,file_names,file_dbname,jobs_conn)
            submitting_center = get_submission_metadata(s3_client,temp_file_loc,files_to_check,file_names,jobs_conn)
...
def get_submission_metadata(s3_client,temp_file_loc,files_to_check,file_names,jobs_conn):
